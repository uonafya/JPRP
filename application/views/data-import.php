...
<section class="content">
    ...
    <form class="donor_form" id="program_details" action="<?php echo base_url('dataimport/fetch_data/');?>" method="post">
        <ul>
            <li>
                <label for="name" style="font-size: 16px; width:250px;margin-left:80%">Import Data from National DHIS2</label>
                <div>
                ...
                <section class="container">
                    <div>
                        ...
                        <div>
                            ...
                            <select name="datasets" id="leftValues" size="4" multiple style="width:450px; height:250px;">
                            </select>
                        </div>
                    </div>
                    ...
                    <div>
                        <div>
                            <div>
                                <label for="name" style="font-size: 16px; margin-left:45px; width: 200px">Selected Datasets </label>
                            </div>
                            <div>
                                <select id="rightValues"  size="5" name='datasets[]' style="width:400px; height:250px;" multiple required readonly>
                                    <?php
