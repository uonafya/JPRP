                ...
                <section class="content-header">
                    <h1>
                        <?php echo $devpartner_details->name; ?>
                    </h1>
                    <ol class="breadcrumb">
                ...
                <section class="content">
					<div class="row"> 
						<div class="box">
                                <div class="box-header">
                                    <h3 class="box-title"> <?php echo $devpartner_details->name; ?> : Programs  </h3>
                                </div><!-- /.box-header -->			
					...
					<div class="row"> 
						<div class="box">
                                <div class="box-header">
                                    <h3 class="box-title"> <?php echo $devpartner_details->name; ?> : Agencies</h3>
                                </div><!-- /.box-header -->			
                                <div class="box-body table-responsive">
                                    <table id="agencies-table" class="table table-bordered table-striped" >                                    	
                                    <thead>
                                        <tr>
                                            <th style="width:50%">Agency Name</th>
                                            <th style="width:20%">Agency Shortname</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<?php
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('body').delegate('#agencies-table .grade_tr', 'click', function (event) {
