                ...
                <form class="donor_form" id="program_details" action="<?php echo base_url('programmanager/updateprogram/'.$program_details->program_id)?>" method="post">
                    <ul>    
                        <li>
                        ...
                        <li>
                            ...
                            <input type="text" name="pname" id="pname"   value="<?php echo $program_details->program_name; ?>"  required pattern="[A-Za-z\s]{10,}"  />
                            <span class="form_hint">Program Name Must Be Of Atleast 10 Characters</span>
                        </li> 
                        <li>
                            <label for="name">Program ShortName:</label>
                            <input type="text" name="sname" id="sname"  value="<?php echo $program_details->program_shortname; ?>"   required pattern="[A-Za-z\s]{2,}"  />
                            <span class="form_hint">Program Name Must Be Of Atleast 2 Characters</span>
                        </li>                                                                     
                        <li>
                            <label for="name">Program Description:</label>
                            <textarea name="pdescription" rows="4" cols="100" required pattern="[A-Za-z\s]{15,}"><?php echo $program_details->program_description; ?></textarea>
                            ...
                            <section class="container">
                                ...
                                <div> 
                                    <div>
                                        ...
                                        <div>
                                            <select id="rightValues"  size="5" name='facilities[]' style="width:400px; height:250px;" multiple required readonly> 
                                            <?php
